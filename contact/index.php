...
?>
    <div class="wrapper wrapper--fill clearfix">
        <div class="breadcrumbs col-xs-7"><a href="/" class="breadcrumbs__item">главная</a> <span class="breadcrumbs__separator">&frasl;</span> <span class="breadcrumbs__current">Контакты</span></div>
    ...
    <div class="wrapper wrapper--fill content-block clearfix">
        <div class="col-xs-10 centered-col clearfix about-page">
            <div class="content-block__img-title">
                <iframe src="https://www.google.com/maps/d/embed?mid=zkLLq1bJ-4ZI.kxNpvmqoEfF0" width="780" height="300"></iframe>
            </div>
